...
const About = () => {
  return (
    <section className="section" id="about">
      <div className="container lg:py-8  lg:ml-[5.5rem]  lg:mr-[5.5rem] mx-auto   rounded-[1rem]  lg:bg-zinc-900/30">
        <div className="flex lg:flex-row h-full items-center flex-col ">
          {/* img */}
          <div className="flex-auto lg:bg-about bg-contain bg-no-repeat   lg:h-[350px]  mix-blend-lighten filter bg-top mr-4 lg:mr-0"></div>
          {/* text */}
